...
# Product spec
TARGET_PRODUCT := pb_ares
TARGET_DEVICE := ares
TARGET_BOARD_PLATFORM := mt6893
TARGET_BOARD_PLATFORM_GPU := mali-g77-mc9
TARGET_BOOTLOADER_BOARD_NAME := ares
...
TW_HANDLE_FSTAB_FORCEENCRYPT := true
TW_HANDLE_FSTAB_QUOTA := true
TW_HANDLE_FSTAB_RESIZE := true
...
TW_CRYPTO_FORCE_ENCRYPT := true
TW_CRYPTO_FORCE_ENCRYPT_FOOTER := true
TW_CRYPTO_SYSTEM_VOLD_DEBUG := true
TW_CRYPTO_SYSTEM_VOLD_DEBUG_LEVEL := 3
